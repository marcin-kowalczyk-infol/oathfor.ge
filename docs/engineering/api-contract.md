...
Consumers must check the HTTP status and validate the JSON object before displaying success. Network errors, unsuccessful responses or invalid payloads are recoverable connectivity errors, not player outcomes. Mobile consumption remains pending. Local boundary rule: [architecture](architecture.md).
