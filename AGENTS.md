...
- Write code, documentation and product terminology in English; communicate with the user in their language. **Local convention: [ADR 0001](docs/decisions/0001-project-foundation.md).**
